...
<head>
    ...
    <style>
        ...
        .navbar-brand i {
            background: linear-gradient(135deg, #7F8C8D 0%, #96CEB4 100%);
        ...
        .btn-primary:hover {
            background:rgb(40, 83, 68);
            transform: translateY(-2px);
            box-shadow: 0 8px 25px rgba(44, 95, 82, 0.3);
        }
        
        .btn-outline-primary {
            border: 2px solid rgb(99, 184, 156);
            color:  #37705D;
            border-radius: 10px;
            transition: all 0.3s ease;
        }
        ...
        .btn-outline-primary:hover {
            background: linear-gradient(135deg, #37705D 0%,  rgb(99, 184, 156) 100%);
        ...
        .empty-state i {
            background: linear-gradient(135deg, #37705D 0%, #96CEB4 100%);
            -webkit-background-clip: text;
            -webkit-text-fill-color: transparent;
            background-clip: text;
        }

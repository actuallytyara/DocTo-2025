...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['place_order'])) {
    try {
        ...
        if ($metode_pembayaran == 'Transfer Bank') {
            $db_payment_method = 'transfer_bank';
...
<body>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 order-lg-1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="tel" class="form-control" id="nomor_telepon" name="nomor_telepon" 
                                       required placeholder="08xxxxxxxxxx" value="<?= isset($_POST['nomor_telepon']) ? htmlspecialchars($_POST['nomor_telepon']) : '' ?>">
                    ...
                    <div class="checkout-card">
                        ...
                        <div id="transfer-info" class="alert alert-info payment-info" style="display: none;">
                        ...
                        <div id="cod-info" class="alert alert-success payment-info" style="display: none;">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (checkedPayment) {
                if (checkedPayment.value === 'Transfer Bank') {

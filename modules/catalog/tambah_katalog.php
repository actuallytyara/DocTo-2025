        ...
        <div class="container">
            ...
            <form method="POST" action="tambah_katalog.php" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" id="nama_barang" name="nama_barang" value="<?php echo isset($_POST['nama_barang']) ? htmlspecialchars($_POST['nama_barang']) : ''; ?>" required>
                </div>
                
                <div class="form-group">
                    <label for="harga_barang">Harga (Rp)</label>
                    <input type="number" id="harga_barang" name="harga_barang" step="0.01" value="<?php echo isset($_POST['harga_barang']) ? htmlspecialchars($_POST['harga_barang']) : ''; ?>" required>
                </div>
                
                <div class="form-group">
                    <label for="jenis_barang">Jenis Obat</label>
                    <input type="text" id="jenis_barang" name="jenis_barang" value="<?php echo isset($_POST['jenis_barang']) ? htmlspecialchars($_POST['jenis_barang']) : ''; ?>" required>
                </div>
                
                <div class="form-group">
                    <label for="gambar">Gambar Produk (opsional)</label>
                    <input type="file" id="gambar" name="gambar" accept="image/jpeg,image/jpg,image/png,image/gif">
                    <small style="color: #666;">Format yang didukung: JPG, JPEG, PNG, GIF (Max 5MB)</small>
                </div>

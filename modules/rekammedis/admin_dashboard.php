...
if (!isset($_SESSION['username']) || $_SESSION['pengguna'] != 'admin') {
...
<head>
    ...
    <style>
        :root {
            --primary-color:rgb(74, 155, 132);
            --secondary-color:rgb(52, 121, 107);
            --accent-color: #f8f9fa;
            --success-color:rgb(40, 167, 125);
            --info-color:rgb(23, 184, 149);
        ...
        .stats-gradient-1 { background: #349b70; }
        .stats-gradient-2 { background:rgb(41, 165, 163); }
        .stats-gradient-3 { background:rgb(163, 208, 86); }
        .stats-gradient-4 { background:rgb(91, 142, 186); }
        .stats-gradient-5 { background: linear-gradient(135deg,rgb(49, 155, 123) 0%,rgb(68, 222, 155) 100%); }
        .stats-gradient-6 { background: linear-gradient(135deg, #a8edea 0%,rgb(214, 254, 233) 100%); }
...
<body>
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    <div class="navbar-brand me-4">
                        <img src="../../assets/images/logo_docto.png" alt="Logo DocTo" style="height: 55px; margin-top: -5px;"> DocTo
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3 col-sm-6 mb-3">
                                <a href="obat.php" class="btn btn-primary w-100 py-3">
                                    <i class="fas fa-plus-circle fa-2x mb-2 d-block"></i>
                                    Tambah Obat
                                </a>
                            </div>
                            <div class="col-md-3 col-sm-6 mb-3">
                                <a href="../dokter/indexdokter.php" class="btn btn-success w-100 py-3">
                                    <i class="fas fa-user-md fa-2x mb-2 d-block"></i>
                                    Data Dokter
                                </a>
                            </div>
                            <div class="col-md-3 col-sm-6 mb-3">
                                <a href="../janjitemu/admin_dashboard.php" class="btn btn-info w-100 py-3">
                            ...
                            <div class="col-md-3 col-sm-6 mb-3">
                                <a href="../../Website Database/admin.php" class="btn btn-primary w-100 py-3">
                            ...
                            <div class="col-md-3 col-sm-6 mb-3">
                                <a href="../pemesanan/admin_dashboard.php" class="btn btn-info w-100 py-3">
                                    <i class="fas fa-cart-plus fa-2x mb-2 d-block"></i>
                                    Data Pemesanan
                                </a>
                            </div>
                            <div class="col-md-3 col-sm-6 mb-3">
                                <a href="../articles/admin_artikel.php" class="btn btn-warning w-100 py-3">
    ...
    <script>
        ...
        const nilaiData = monthlyData.map(item => item.total_nilai / 1000000);
